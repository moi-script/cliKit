"""
file_reader.py - Repository Content Scraper
Used by VibeCLI to inject full codebase context into AI conversations.
"""
...
SKIPPED_NAMES = {
    ...
    '.DS_Store', 'Thumbs.db', '.vibe'  # Added .vibe to skip backup folder
}
...
def scrape_contents(root_path: Path) -> str:
    ...
    Args:
        root_path: Path object pointing to the directory to scrape
...
def main():
    """Standalone CLI usage for testing the scraper."""
    import argparse
